...
export default function Card({img,judul,ket} : AppProps) {
    
   
  return (
    <div className=" border border-gray-100 shadow-md shadow-gray-300 p-3 rounded-md hover:shadow-2xl  duration-300">
    ...
    <div className="flex gap-5 mt-3">
        ...
        <div className=" bg-gray-300 px-2 py-1">
            <p className="text-xs font-medium">Laravel</p>
        </div>

    </div>
    <p className="my-6 text-base ">{ket}</p>
