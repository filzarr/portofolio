...
export default function Portofolio() {
    ...
    return (
        <section className='pt-32 pb-10 dark:bg-drk' id="portofolio">
            ...
            <div className="md:px-32 mt-20 px-5">
            ...
            <div className="w-full flex px-10 justify-center md:justify-end md:px-32 mt-20">
                <nav aria-label="Page navigation example">
                    <ul className="md:inline-flex -space-x-px text-base h-10 hidden ">
                        <li>
                ...
                <nav aria-label="Page navigation example">
                    <ul className="max-sm:inline-flex hidden -space-x-px text-sm">
                        <li>
