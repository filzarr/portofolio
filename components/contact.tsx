...
export default function Contact() {
    return (
        <section id='contact' className='md:h-screen pt-36 md:px-28 px-5   pb-10 dark:bg-drk'>
            <div className=" max-sm:flex max-sm:justify-center  ">
                <p className='md:text-4xl text-5xl font-bold text-emerald-400'>Contact US</p>
            </div>
            <div className="md:flex gap-20 ">
                <div className=" md:w-1/5 mt-20"><p className='text-2xl font-bold text-emerald-400'>For More Information Sign Up With US Here: <button className='md:block hidden mt-10 w-full hover:bg-emerald-400 py-3 border border-emerald-400 duration-100 hover:text-white rounded-xl'>Submit</button></p></div>
                <div className="md:w-2/6 mt-20">
                    <div className="mb-6">
                        ...
                        <button className='block md:hidden mt-10 w-full hover:bg-emerald-400 py-3 border border-emerald-400 duration-100 hover:text-white rounded-xl'>Submit</button>
                    </div>

                </div>
                <div className=" max-sm:mt-10  flex items-center justify-center  font-semibold text-2xl text-gray-800 text-center dark:text-emerald-400">OR</div>
                <div className=" max-sm:mt-10 md:w-2/6 flex flex-col gap-14">
                    <a href="">
