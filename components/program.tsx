...
export default function Program({img, ket}: AppProps ) {
  return (
    <button className="  rounded-full border border-gray-100 bg-white  shadow-xl  hover:shadow-gray-400  ease-in shadow-gray-300 flex items-center justify-center p-4      group">
