...
export default function Program({img, ket}: AppProps ) {
  return (
    <button className=" dark:bg-[#132347]  dark:border dark:border-black/0    dark:shadow-md  rounded-full border border-gray-100 bg-white  shadow-xl  hover:shadow-gray-400  ease-in shadow-gray-300 flex items-center justify-center p-4      group">
